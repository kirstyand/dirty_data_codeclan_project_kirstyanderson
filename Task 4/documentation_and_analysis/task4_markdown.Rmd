...
The survey differs slightly each year, but in general it asks the users' age, gender, location, if they plan on "trick - or - treating", and then goes on to ask the user their opinion on various types of Halloween candy. It also asks the users opinion on various other topics.
...
2. Assumptions
- I have made some assumptions in regards to column names across the 3 sets e.g. bonkers(2015) = bonkers_the_candy (2016 & 2017) and not bonkers_the_boardgame. 
...
- I knew that I was going to join the 3 datasets together, and wanted to preserve the year each observation was recorded,
  I added a constant value column containing the year to the beginning of each dataset e.g.:
```{r}
candy_2015_clean <- candy_2015_clean %>% 
